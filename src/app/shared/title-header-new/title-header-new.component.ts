...
@Component({
  selector: 'app-title-header-new',
  templateUrl: './title-header-new.component.html',
  styleUrls: ['./title-header-new.component.scss'],
  providers: [
    {
      provide: DateAdapter,
...
export class TitleHeaderNewComponent implements OnInit {
  ...
  searchFunction(){
    ...
    if(this.searchHasInputOption){
      searchQuery = {Dates:this.dateValues,searchInput:this.inputSearchBox.getRawValue()}
    }
