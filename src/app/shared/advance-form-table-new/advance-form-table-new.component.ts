...
@Component({
  selector: 'app-advance-form-table-new',
  templateUrl: './advance-form-table-new.component.html',
  styleUrls: ['./advance-form-table-new.component.scss']
})
export class AdvanceFormTableNewComponent implements OnInit {
