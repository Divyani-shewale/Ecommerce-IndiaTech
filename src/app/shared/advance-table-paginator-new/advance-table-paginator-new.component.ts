...
@Component({
  selector: 'app-advance-table-paginator-new',
  templateUrl: './advance-table-paginator-new.component.html',
  styleUrls: ['./advance-table-paginator-new.component.scss']
})
export class AdvanceTablePaginatorNewComponent implements OnInit {
